...
const cases = [
  ...
  { id: "sku", emoji: "🏷️", who: "Every Consumer", title: "SKU Intelligence: Stop Overpaying", body: "Every product has a better price somewhere. The question is: are you finding it? Retailers use sophisticated pricing engines to maximize what you pay. Now you have your own intelligence system — tracking every SKU across your purchases, monitoring price changes automatically, and alerting you when you're owed a refund.", stats: [["97.4%","SKU-to-transaction match accuracy"],["8–12%","average savings on tracked purchases"],["4,000+","merchants supported at launch"]], bullets: ["Track every SKU across every purchase automatically","Get instant alerts when prices drop after you buy","Auto-request refunds when you're owed one","See when brands quietly raise prices between purchases","Cross-store comparison — same item, cheaper store, flagged"] },
